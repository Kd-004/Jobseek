...
namespace mainProject.Migrations
{
    ...
    [Migration("20260717072326_jobapplication")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mainProject.Models.JobApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("mainProject.Models.JobApplication", b =>
                {
                    b.HasOne("mainProject.Models.Company", "Company")
                        .WithMany()
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("mainProject.Models.Job", "Job")
                        .WithMany()
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
